            ...
            <div className="flex flex-col gap-[114px] md:gap-[85px] sm:gap-[57px]">
              ...
              <div className="flex items-center md:flex-col">
                ...
                <div className="flex flex-1 flex-col items-start gap-[18px] md:self-stretch">
                  ...
                  <Heading
                    as="h2"
                    className="text-[16px] font-medium tracking-[-0.20px]"
                  >
                    {" "}
                    Not ready to checkout? Continue Shopping{" "}
                  </Heading>{" "}
                  <div className="mr-[86px] flex flex-col gap-3.5 self-stretch md:mr-0">
                    {" "}
                    <ProductDetails1 /> <ProductDetails1 />{" "}
                  </div>{" "}
                </div>{" "}
                <div className="flex w-[42%] flex-col items-start gap-7 md:w-full">
                  {" "}
                  <Heading
                    size="heading_04"
                    as="h3"
